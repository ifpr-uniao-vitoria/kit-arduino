/*
 * Exemplo: Controle de Posição de Servo Motor com Potenciômetro (Avançado)
 * Autor: Deividson Luiz Okopnik
 * Placa: Arduino Uno
 *
 * Descrição:
 * Este código demonstra a integração de um Potenciômetro como entrada analógica
 * para controlar em tempo real a posição angular de um Servo Motor.
 *
 ...
 *
 * Observações:
 * A função map() é essencial para converter a faixa de leitura do potenciômetro (0-1023)
