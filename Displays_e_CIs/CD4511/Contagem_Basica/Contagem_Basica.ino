/*
 * Exemplo: Contagem Básica em Display 7 Segmentos com CI CD4511
 * Autor: Deividson Luiz Okopnik
 * Placa: Arduino Uno
 *
 * Descrição:
 * Este código demonstra o uso do CI decodificador BCD para 7 segmentos CD4511 para
 * realizar uma contagem simples de 0 a 9, usando apenas 4 pinos digitais do Arduino.
 *
 ...
 *
 * Observações:
 * O CD4511 simplifica o código, pois o Arduino só precisa enviar o valor BCD (0 a 9)
 * e o CI se encarrega de acender os segmentos corretos.
 */
